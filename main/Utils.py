...
def getPandId():
    ...
    pand_id_dict = {"pand_id": int(pand_id), "channel_no": channel_no, "zbsVer": zbsVer, "zbhVer": zbhVer}
    try:
        ...
        logInfo("Host pand id: %d, channel no: %s" % (pand_id, channel_no))
        return pand_id_dict
...
rayLogger = logging.getLogger(loggername)
...
def loggerInit():
    ...
    rayRotatingHandler.setFormatter(fhformatter)
    # add the handlers to logger
    logger.addHandler(ch)
    # logger.addHandler(fh)
    logger.addHandler(rotatingHandler)

    rayLogger.addHandler(ch)
    rayLogger.addHandler(rayRotatingHandler)
loggerInit()
...
def rayLogError(msg):
    try:
        ...
        rayLogger.error("!!!!ERROR!!!!!!!ERROR!!!!!!!ERROR!!!!!! %s, traceback:%s"%(msg, tracestr))
